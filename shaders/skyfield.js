/**
Based on shader from https://www.shadertoy.com/view/lslSDS
**/
...
void main()
{
	...
	float b = 10.0;
	float c = 1.0;
	float fZPos = 5.0;// + u_time * c + sin(u_time * a) * b;
	float fSpeed = 0.; //c + a * b * cos(a * u_time);
